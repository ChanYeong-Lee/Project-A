...
public class HorseMoveWithStateMachine : MonoBehaviour
{
    public enum State
    {
        Idle,
    ...
    private void Update()
    {
        ...
        animator.SetFloat("Horizontal", horizontal, 0.5f, Time.deltaTime);
        ...
        if (characterAnimator != null)
        {
            ...
            //characterAnimator.SetFloat("Height", 1 - slope.Height * 0.5f);
    ...
    private void JumpUpdate()
    {
        ...
        //if ((slope.isGround || slope.Height < 0.15f) && prepareJumpTimeoutDelta < 0.0f)
        //{
        //    if (0.1f < vertical)
        //    {
        //        ChangeState(State.Locomotion);
